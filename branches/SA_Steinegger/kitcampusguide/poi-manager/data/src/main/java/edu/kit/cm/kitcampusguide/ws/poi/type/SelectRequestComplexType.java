...
/**
 * <p>
 * Java class for SelectRequestComplexType complex type.
 * 
 * <p>
...
@XmlType(name = "SelectRequestComplexType", propOrder = { "findByNamesLike", "findByNames", "findByNameSuffixes",
        "findByNamePrefixes", "findByIds" })
public class SelectRequestComplexType implements Serializable {

    private static final long serialVersionUID = 2941346976491757340L;
