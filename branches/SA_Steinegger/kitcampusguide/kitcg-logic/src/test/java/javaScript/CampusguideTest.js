 ...
 * 
 * The current poi is "Mensa am Adenauerring" and current route goes from "Gerthsen Hörsaal" to "Mensa am Adenauerring".
 */
	 ...
	 * <div id="campusguide" style="width: 760px; height: 530px; ">
               <div id="headline" style="width: 758px; height: 28px; ">
                    <div id="headline-content">
                    	<span id="test:search:current-poi" class="hidden">{"id":2,"icon":"..\/images\/icons\/mensa.jpg","lon":8.41684,"description":"Das ist die Mensa. Freßtempel für alle Studenten.","name":"Mensa am Adenauerring","nameSize":21,"lat":49.01198}</span>
                    </div>
