...
<html lang="de">
  ...
  <body class="monitor">
    ...
    <div id="workstations" class="container">
	    ...
	    <div class="row">
		    <div class="span2"><a class="btn btn-success">A1</a></div>
		    <div class="span2"><a class="btn btn-success">A2</a></div>
		    <div class="span2"><a class="btn btn-warning">A3</a></div>
		    <div class="span2"><a class="btn btn-warning">A4</a></div>
		    <div class="span2"><a class="btn btn-success">A5</a></div>
		    <div class="span2"><a class="btn btn-danger">A6</a></div>
	    </div>

        <div class="row">
            <div class="span2"><a class="btn btn-danger">B1</a></div>
            <div class="span2"><a class="btn btn-danger">B2</a></div>
            <div class="span2"><a class="btn btn-success">B3</a></div>
        ...
        <div class="row">
            ...
            <div class="span2"><a class="btn btn-primary">C2</a></div>
            <div class="span2"><a class="btn btn-danger">C3</a></div>
            <div class="span2"><a class="btn btn-success">C4</a></div>
            <div class="span2"><a class="btn btn-warning">C5</a></div>
        ...
        <div class="row">
            <div class="span2"><a class="btn btn-success">F1</a></div>
            <div class="span2"><a class="btn btn-success">F2</a></div>
            <div class="span2"><a class="btn btn-success">F3</a></div>
            <div class="span2"><a class="btn btn-warning">F4</a></div>
            <div class="span2"><a class="btn btn-warning">F5</a></div>
            <div class="span2"><a class="btn btn-warning">F6</a></div>
        </div>
