...
public class MapModel {
	...
	/**
	 * @param mapSection the mapSection to set
	 */
	...
	/**
	 * @param highlightedPOI the highlightedPOI to set
	 */
	...
	/**
	 * @param markerFrom the markerFrom to set
	 */
	...
	/**
	 * @param markerTo the markerTo to set
	 */
	...
	/**
	 * @param buildingPOI the buildingPOI to set
	 */
	...
	/**
	 * @param buildingPOIList the buildingPOIList to set
	 */
