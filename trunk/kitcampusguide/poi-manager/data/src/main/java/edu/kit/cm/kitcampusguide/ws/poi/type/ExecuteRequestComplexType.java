...
/**
 * <p>
 * Java class for ExecuteRequestComplexType complex type.
 * 
 * <p>
...
@XmlType(name = "ExecuteRequestComplexType", propOrder = { "createRequestsOrReadRequestsOrUpdateRequests" })
public class ExecuteRequestComplexType {

    @XmlElements({ @XmlElement(name = "readRequests", type = ReadRequestComplexType.class),
    ...
    /**
     * Gets the value of the createRequestsOrReadRequestsOrUpdateRequests
     * property.
     * 
     * <p>
     ...
     * createRequestsOrReadRequestsOrUpdateRequests property.
     * 
     * <p>
     ...
     * {@link ReadRequestComplexType } {@link DeleteRequestComplexType }
     * {@link UpdateRequestComplexType } {@link CreateRequestComplexType }
    ...
    public void addRequest(Object request) {
        getCreateRequestsOrReadRequestsOrUpdateRequests().add(request);
    }
