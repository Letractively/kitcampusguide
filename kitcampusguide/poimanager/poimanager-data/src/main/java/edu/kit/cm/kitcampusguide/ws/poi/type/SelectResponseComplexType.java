...
/**
 * <p>
 * Java class for SelectResponseComplexType complex type.
 * 
 * <p>
...
@XmlType(name = "SelectResponseComplexType", propOrder = { "successMessage", "poi" })
public class SelectResponseComplexType implements Serializable {

    private static final long serialVersionUID = 5239574921757315128L;
    ...
    public void convertPoisForResponse(List<POI> foundPois) {
        for (POI poi : foundPois) {
            getPoi().add(new PoiWithId(poi, poi.getCategoryName()));
        }
    }
