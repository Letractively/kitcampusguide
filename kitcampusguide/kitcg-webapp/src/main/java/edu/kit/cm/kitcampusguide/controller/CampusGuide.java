...
/**
 * Objects of this class are associated with a session of an user of the
 * KITCampusGuide through the ManagedBean technology of JavaServer Faces storing
...
public class CampusGuide {
	 ...
	 * 
	 * @param ev
	 *            the ValueChangeEvent storing the new search string.
	 */
	 ...
	 * 
	 * @param ev
	 *            the ValueChangeEvent storing the new value of the from-field.
	 */
	 ...
	 * 
	 * @param ev
	 *            the ValueChangeEvent storing the new value of the to-field.
	 */
	...
	private POI generateMarker(String text) {
		...
		return new POI(text, 42, null, "", new Double(coordinates[0]), new Double(coordinates[1]));
	}

	/**
	 * This method updates the current route due to the currently stored due to
	 * the current starting and destination point.
	 */
