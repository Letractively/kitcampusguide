...
public final class RouteCalculatingUtility {
	...
	private static double getDistance(Point pointFrom, Point pointTo) {
		double heightFrom = getLengthByPolarCoordinates(pointFrom.getLongitude());
		double heightTo = getLengthByPolarCoordinates(pointTo.getLongitude());
		double widthFrom = getLengthByPolarCoordinates(pointFrom.getLatitude());
		double widthTo = getLengthByPolarCoordinates(pointTo.getLatitude());
