...
/**
 * Just a modified version of DijkstraRoutingTest.
 */
public class PreCalculatedRoutingTest {
	...
	public void testConstructRoute() {
		...
		PreCalculatedRouting preCalculatedRoutingTest = PreCalculatedRouting.getInstance();
		...
		assertTrue((route1.equals(preCalculatedRoutingTest.calculateRoute(from2, route1end))));
	}
	...
	public void testConstructRouteNotConnected() {
		...
		assertNull(preCalculatedRoutingTest.calculateRoute(from1, notConnected));
	}
