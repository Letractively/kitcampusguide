...
/**
 * This interface represents a facade of the map algorithms package and
 * encapsulates all functionality provided by this package.
 * 
...
public interface MapAlgorithms {
	 ...
	 * the specified String. After that the POI with the highest correspondence
	 * is returned
	 * 
	 * @param name
	 *            the String to search for
