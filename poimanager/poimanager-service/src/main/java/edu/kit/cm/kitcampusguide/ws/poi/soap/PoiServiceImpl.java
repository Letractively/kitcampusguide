...
@WebService(serviceName = "PoiService", portName = "PoiServiceSOAP", targetNamespace = "http://cm.tm.kit.edu/kitcampusguide/poiservice/", wsdlLocation = "http://localhost:8080/poimanager-service/poiservice/?wsdl", endpointInterface = "edu.kit.tm.cm.kitcampusguide.poiservice.PoiService")
@Transactional
